...
const AboutMe = () => {
  return (
    <div>
      <div className="flex items-center justify-center pb-5 lg:pb-16">
      ...
      <div className=" mx-auto px-5 lg:px-20 py-20 min-h-screen flex flex-col justify-evenly items-center">
